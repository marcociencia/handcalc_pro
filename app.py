# app.py – Fixed version with proper escaping
import streamlit as st
import streamlit.components.v1 as components
import math
import sympy as sp
from sympy import (symbols, diff, integrate, solve, latex, simplify, expand,
                   sin, cos, tan, exp, log, Symbol, sqrt, pi, I, Matrix)
        ...
        try:
            ...
            <div class="step-box">
                ...
                <div class="step-detail">
                    ...
                    <div class="formula-highlight">
                        $$\\begin{{cases}} {latex(expr1)} = 0 \\\\ {latex(expr2 - k \\times expr1)} = 0 \\\\ {latex(expr3 - k \\times expr1)} = 0 \\end{{cases}}$$
                    </div>
                </div>
