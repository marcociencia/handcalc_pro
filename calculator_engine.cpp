...
public:
    ...
    std::string multiply(std::string a, std::string b) {
        ...
        if (floor(num1) == num1 && floor(num2) == num2) {
            ...
            visual << "Ã—" << std::string(totalWidth - std::to_string(n2).length() - 1, ' ') << n2 << "\n";
            visual << createLine(totalWidth) << "\n";
            ...
            std::ostringstream visual;
            visual << std::string(totalWidth - a.length(), ' ') << a << "\n";
            visual << "Ã—" << std::string(totalWidth - b.length() - 1, ' ') << b << "\n";
            visual << createLine(totalWidth) << "\n";
    ...
    std::string divide(std::string a, std::string b) {
        ...
        std::ostringstream visual;
        visual << a << " Ã· " << b << " = " << formatNumber(result) << "\n";
    ...
    std::string squareRoot(std::string num) {
        ...
        std::ostringstream visual;
        visual << "âˆš" << num << " = " << formatNumber(result) << "\n\n";
    ...
    std::string cubeRoot(std::string num) {
        ...
        std::ostringstream visual;
        visual << "âˆ›" << num << " = " << formatNumber(result) << "\n\n";
    ...
    std::string ruleOfThree(std::string a, std::string b, std::string c) {
        ...
        visual << c << " â€”â€”â€”â†’ x\n\n";
        visual << "x = (" << b << " Ã— " << c << ") Ã· " << a << "\n";
        visual << "x = " << formatNumber(val2 * val3) << " Ã· " << a << "\n";
    ...
    std::string integrate(std::string expression, std::string lower, std::string upper, int intervals = 100) {
        ...
        visual << "âˆ« " << expression << " dx from " << lower << " to " << upper << "\n\n";
        ...
        visual << "Result â‰ˆ " << formatNumber(result) << "\n";
    ...
    std::string derivative(std::string expression, std::string point) {
        ...
        // Using central difference formula: f'(x) â‰ˆ (f(x+h) - f(x-h)) / (2h)
        ...
        visual << "f'(" << formatNumber(x) << ") â‰ˆ ";
        visual << "[f(" << formatNumber(x + h) << ") - f(" << formatNumber(x - h) << ")] / (2 Ã— " << h << ")\n";
        visual << "f'(" << formatNumber(x) << ") â‰ˆ (" << formatNumber(f_plus) << " - " 
               << formatNumber(f_minus) << ") / " << formatNumber(2 * h) << "\n";
        visual << "f'(" << formatNumber(x) << ") â‰ˆ " << formatNumber(derivative) << "\n";
